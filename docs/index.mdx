...
<p align="center">
  <img
    width="120"
    src="https://user-images.githubusercontent.com/545047/191621556-6f1baa40-15ff-4465-8d80-63b3ff9bc23a.svg"
  />
</p>
...
>
  ...
  <a
    style={{ paddingRight: "4px" }}
    href="https://www.npmjs.com/package/@cosmwasm/ts-codegen"
  >
    <img height="20" src="https://img.shields.io/npm/dt/@cosmwasm/ts-codegen" />
  </a>
  <a
    style={{ paddingRight: "4px" }}
  ...
  > 
    <img
      height="20"
      src="https://img.shields.io/github/package-json/v/CosmWasm/ts-codegen?filename=packages%2Fts-codegen%2Fpackage.json"
    />
  </a>
</div>
...
<DownloadButton href='/llms/ts-codegen.txt' fileName="ts-codegen-llms.txt" />
