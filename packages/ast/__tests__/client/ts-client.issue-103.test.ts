...
const globbed = globLegacyContracts('issues/103').find(
...
describe('query', () => {
  ...
  it('execute classes array types', () => {
    expectCode(
      createExecuteClass(queryCtx, 'Client', 'Instance', null, queryMessage)
    );
  });

  it('execute interfaces no extends', () => {
    expectCode(
      createExecuteInterface(queryCtx, 'SG721Instance', null, queryMessage)
    );
  });
});
...
describe('execute', () => {
  ...
  it('execute classes array types', () => {
    expectCode(
      createExecuteClass(executeCtx, 'Client', 'Instance', null, executeMessage)
    );
  });

  it('execute interfaces no extends', () => {
    expectCode(
      createExecuteInterface(executeCtx, 'SG721Instance', null, executeMessage)
    );
  });
});
