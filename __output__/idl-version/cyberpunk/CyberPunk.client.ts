...
export interface CyberPunkInterface extends CyberPunkReadOnlyInterface {
  ...
  mirrorEnv: (fee_?: number | StdFee | "auto", memo_?: string, funds_?: Coin[]) => Promise<any>;
}
export class CyberPunkClient extends CyberPunkQueryClient implements CyberPunkInterface {
  ...
  mirrorEnv = async (fee_: number | StdFee | "auto" = "auto", memo_?: string, funds_?: Coin[]): Promise<any> => {
    return await this.client.execute(this.sender, this.contractAddress, {
      mirror_env: {}
    }, fee_, memo_, funds_);
  };
